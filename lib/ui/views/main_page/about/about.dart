...
class AboutScreenView extends StatelessWidget {
  ...
  final List<_AuthorProfile> _authors = [
    ...
    _AuthorProfile.create("Паймухин Виталий Евгеньевич", "vitaly.png",
...
class _AuthorProfile {
  ...
  factory _AuthorProfile.create(String fullName, String avatarAssetName,
