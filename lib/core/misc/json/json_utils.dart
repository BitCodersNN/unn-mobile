...
T getValueFromJson<T>(JsonMap json, String key, T defaultValue) {
...
String getStringFromJson(JsonMap json, String key) =>
...
List getListFromJson(JsonMap json, String key) =>
    getValueFromJson(json, key, []);
