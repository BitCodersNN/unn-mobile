  ...
  Future<Map<BlogPostType, List<BlogPost>>?> refreshBlogPosts({
    ...
    try {
      response = await _apiHelper.post(
        ...
        data: {
          FeedDataKeys.logajax: FeedDataVelues.y,
          FeedDataKeys.reload: FeedDataVelues.y,
          FeedDataKeys.useBXMainFilter: FeedDataVelues.y,
          FeedDataKeys.siteTemplateId: FeedDataVelues.bitrix24,
          FeedDataKeys.assetsCheckSum: assetsCheckSum,
