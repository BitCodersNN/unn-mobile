  ...
  Future<Map<BlogPostType, List<BlogPost>>?> loadNextPageBlogPosts({
    ...
    try {
      response = await _apiHelper.post(
        ...
        data: {
          FeedDataKeys.logajax: _DataVelues.y,
          FeedDataKeys.noblog: FeedDataVelues.n,
          FeedDataKeys.pageNumber: pageNumber,
          FeedDataKeys.lastLogTimestamp:
              DateTime.now().millisecondsSinceEpoch ~/ 1000,
          FeedDataKeys.prevPageLogId: pinIds.join('|'),
          FeedDataKeys.siteTemplateId: _DataVelues.bitrix24,
          FeedDataKeys.useBXMainFilter: _DataVelues.y,
          FeedDataKeys.presentFilterTopId: '',
          FeedDataKeys.presentFilterId: '',
          FeedDataKeys.commentFormUID: commentFormUID,
          FeedDataKeys.blogCommentFormUID: blogCommentFormUID,
          FeedDataKeys.context: '',
          FeedDataKeys.signedParameters: signedParameters,
        },
