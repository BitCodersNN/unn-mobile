<div align="center">
  <img 
    width="200" 
    src="https://github.com/BitCodersNN/unn-mobile.assets/blob/develop/loading_screen/logos/default-logo.png?raw=true" 
    alt="Логотип Студенческого Хаба ННГУ"
  />
...
- [Статистика и отзывы](#статистика-и-отзывы)
- [Установка](#установка)
...
## Команда разработки:
- [Юрин Андрей](https://t.me/@Namxobick), [Крисеев Михаил](https://t.me/@kriseev) (текущая команда);
- Соколова Дарья, Ванюшкин Дмитрий, Паймухин Виталий (участвовали ранее).
